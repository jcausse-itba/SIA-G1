...
class GAEngine:
    ...
    def run(self) -> Individual:
        ...
        add_tri_prob   = cfg.get("rm_tri_prob", 0.041432)
        rm_tri_prob    = cfg.get("rm_tri_prob", 0.028916)
        p_tri          = cfg.get("p_tri",           0.107201)
        p_comp         = cfg.get("p_comp",          0.014158)
